...
public class PrintQueue {
	 ...
	 */
	public void lprd() {
		if( printQ.size() > 1 ) {// : if the size of the print queue is greater than 1 then
		Job front = printQ.dequeue();
		printQ.enqueue(front);// dequeue the Job at the head of the queue and enqueue it to the rear.
		}
